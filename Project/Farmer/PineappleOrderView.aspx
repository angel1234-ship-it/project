<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer/FarmerMaster.master" AutoEventWireup="true" CodeFile="PineappleOrderView.aspx.cs" Inherits="Farmer_Default" %>
                ...
                <asp:DataList ID="datalistorder" runat="server" CellPadding="4" ForeColor="#333333" RepeatDirection="Horizontal">
                    ...
                    <ItemTemplate>
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td>Pineapple &nbsp;
                                    <asp:Label ID="lbname" runat="server" Text='<%# Eval("farmerproduct_name") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>Order&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           ...
                           <%-- <tr>
                                <td>Booking&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbdate" runat="server" Text='<%# Eval("productbooking_date") %>'></asp:Label>
                                </td>
                            </tr>--%>
                        </table>
                    </ItemTemplate>
