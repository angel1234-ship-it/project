<%@ Page Title="" Language="C#" MasterPageFile="~/Agency/AgencyMaster.master" AutoEventWireup="true" CodeFile="AgencyPostComplaintView.aspx.cs" Inherits="Agency_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        <tr>
            ...
            <td>
                <asp:GridView ID="grdagency" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grdagency_PageIndexChanging" PageSize="5" ForeColor="#333333" GridLines="None">
