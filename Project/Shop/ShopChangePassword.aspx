<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMaster.master" AutoEventWireup="true" CodeFile="ShopChangePassword.aspx.cs" Inherits="Shop_Default" %>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtcpassword" ErrorMessage="Please enter current password" style="color: #FF0000"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td class="auto-style4">Confirm Password<span class="auto-style3">*</span></td>
