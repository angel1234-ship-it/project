...
public partial class Shop_Default : System.Web.UI.Page
{
    ...
    protected void btnsend_Click(object sender, EventArgs e)
    {
        ...
        string insQry = "insert into tbl_complaint(shop_id,complaint_title,complaint_content,complaint_date) values('" + idNo + "','" + txttitle.Text + "','" + txtcomplaint.Text + "','" + DateTime.Now.ToShortDateString() + "')";
