<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMaster.master" AutoEventWireup="true" CodeFile="ShopComplaintView.aspx.cs" Inherits="Shop_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        <tr>
            ...
            <td>
                <asp:GridView ID="grdshopreply" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grdshopreply_PageIndexChanging" ForeColor="#333333" GridLines="None">
