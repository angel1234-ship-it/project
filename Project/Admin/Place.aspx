...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtpin" runat="server" Width="300px" OnTextChanged="txtpin_TextChanged" AutoPostBack="True"></asp:TextBox>
            &nbsp;
        ...
        <tr>
            ...
            <td class="auto-style2">&nbsp;</td>
            <td>
                <asp:GridView ID="grdplace" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EmptyDataText="No Record" GridLines="Vertical" OnRowCommand="grdplace_RowCommand" OnPageIndexChanging="grdplace_PageIndexChanging">
