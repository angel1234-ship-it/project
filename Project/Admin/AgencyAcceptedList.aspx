    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style7">
                &nbsp;</td>
            <td class="auto-style7">
                <asp:GridView ID="grdagencyaccepted" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No Record" OnPageIndexChanging="grdagencyaccepted_PageIndexChanging" OnRowCommand="grdagencyaccepted_RowCommand" Height="364px" PageSize="5" Width="879px" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="grdagencyaccepted_SelectedIndexChanged">
