...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style2">Amount<span class="auto-style3">*</span></td>
            <td>
                <asp:TextBox ID="txtamount" runat="server" Width="300px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtamount" ErrorMessage="Please enter amount" style="color: #FF0000"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
