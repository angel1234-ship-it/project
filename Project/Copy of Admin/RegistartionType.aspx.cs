...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        if(flag==1)
        {
            string UpQry="update tbl_regtype set regtype_name='"+txtregtype.Text+"',regtype_validity='"+txtvalidity.Text+"' where regtype_id='"+edID+"'";
        ...
        {
        string insQry = "insert into tbl_regtype(regtype_name,regtype_validity)values('" + txtregtype.Text + "','"+txtvalidity.Text+"')";
