<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer/FarmerMaster.master" AutoEventWireup="true" CodeFile="RegistrationFeeView.aspx.cs" Inherits="Farmer_Default" %>
            ...
            <td>
                <asp:DetailsView ID="dvsub" runat="server" AutoGenerateRows="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="50px" OnItemCommand="dvsub_ItemCommand" Width="125px" >
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnsub" runat="server" CommandArgument='<%# Eval("regtype_id") %>' CommandName="sub" Text="PayNow" Width="120px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Fields>
