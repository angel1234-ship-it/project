<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer/FarmerMaster.master" AutoEventWireup="true" CodeFile="PostComplaintView.aspx.cs" Inherits="Farmer_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        <tr>
            ...
            <td>
                <asp:GridView ID="grdfarmer" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="complaint_replydate" HeaderText="Reply Date" DataFormatString="{0:dd/MM/yyyy}" />
                    </Columns>
