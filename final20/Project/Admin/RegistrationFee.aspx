    ...
    <table class="auto-style1">
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddregtype" ErrorMessage="please select registration type" style="color: #FF0000" InitialValue="--select--"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
